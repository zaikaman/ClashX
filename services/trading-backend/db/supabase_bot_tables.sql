...
create unique index ix_bot_strategy_versions_bot_definition_version on public.bot_strategy_versions(bot_definition_id, version_number);
create index ix_bot_strategy_versions_created_by_user_id on public.bot_strategy_versions(created_by_user_id);
create index ix_bot_strategy_versions_created_at on public.bot_strategy_versions(created_at desc);
...
create index ix_bot_publish_snapshots_bot_definition_id on public.bot_publish_snapshots(bot_definition_id);
create index ix_bot_publish_snapshots_strategy_version_id on public.bot_publish_snapshots(strategy_version_id);
create index ix_bot_publish_snapshots_created_at on public.bot_publish_snapshots(created_at desc);
