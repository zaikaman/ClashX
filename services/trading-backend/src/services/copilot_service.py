...
class CopilotService:
            ...
            attempts.append(
                _ProviderAttempt(
                    ...
                    request_coro=lambda: self._run_conversation(
                        ...
                        request_model=lambda conversation: self._request_trollllm(conversation, system_prompt),
                    ),
                )
            )
    ...
    async def _request_trollllm(self, messages: list[dict[str, str]], system_prompt: str) -> str:
    ...
    def _has_trollllm_config(self) -> bool:
        return bool(self.settings.trollllm_api_key and self.settings.trollllm_base_url and self.settings.trollllm_model)
