- Make sure when working with UI tasks, use the frontend-design skill in the .agents/skills/frontend-design folder, and make sure your UI is consistent with the overall web design. 
