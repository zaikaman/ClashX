  ...
  return (
    <main className="shell grid gap-8 pb-10 md:pb-12">
        ...
        <div className="grid gap-4 lg:grid-cols-[1.1fr_0.9fr] lg:items-end">
          ...
          <div className="grid gap-3 rounded-[1.5rem] border border-[rgba(255,255,255,0.06)] bg-[#0d0f10] p-5">
            <div className="flex items-center justify-between gap-3">
              ...
              {profile?.creator ? (
                <Link
                  href={`/leaderboard/creators/${profile.creator.creator_id}`}
      ...
      <section className="grid gap-4 md:grid-cols-4">
          <HeroStat label="Leaderboard rank" value={profile?.rank ? `#${profile.rank}` : loading ? "..." : "Unranked"} accent="text-[#dce85d]" />
