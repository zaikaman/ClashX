      ...
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="flex items-center justify-between h-14">
          ...
          <div className="hidden md:flex items-center gap-3">
            <a href="https://github.com/zaikaman/ClashX" target="_blank" rel="noopener noreferrer" className="p-1.5 text-neutral-400 hover:text-neutral-50 transition-colors">
              <Github size={16} />
            </a>
          </div>
